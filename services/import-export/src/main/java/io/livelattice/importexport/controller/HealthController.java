...
public class HealthController {
    ...
    private static final String SERVICE = "import-export";
    ...
    public HealthController(StringRedisTemplate redisTemplate,
        ...
        this(redisTemplate, minioClient, adminClient, properties, null);
    }
    ...
    private CachedReadiness evaluate(Instant now) {
        ...
        boolean healthy = healthy(database) && healthy(storage) && healthy(queue) && healthy(cache);
    ...
    private Map<String, Object> checkStorage() {
        ...
        try {
            ...
            check.put("bucket", properties.storageBucket());
            return check;
        } catch (Exception e) {
