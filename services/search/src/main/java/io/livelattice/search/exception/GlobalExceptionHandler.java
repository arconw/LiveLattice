...
import io.livelattice.search.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleSearchBackend(SearchBackendException ex) {
        return ResponseEntity.status(HttpStatus.BAD_GATEWAY)
            .body(new ErrorResponse("search_backend_error", ex.getMessage()));
    }
